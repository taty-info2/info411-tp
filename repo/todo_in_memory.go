...
type TodoRepoInMem struct {
	todos []info411.Todo
}

func NewTodoRepoInMem() *TodoRepoInMem {
	return &TodoRepoInMem{
		todos: []info411.Todo{
...
func (t *TodoRepoInMem) List() ([]info411.Todo, error) {
	return t.todos, nil
}

func (t *TodoRepoInMem) FindById(id int64) (info411.Todo, error) {
...
func (t *TodoRepoInMem) Insert(todo *info411.Todo) error {
...
func (t *TodoRepoInMem) Delete(id int64) error {
...
func (t *TodoRepoInMem) Complete(id int64, c bool) error {
	found := false
